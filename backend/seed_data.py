...
SCENARIOS = [
    ...
    },
    {
        "department": "Üretim",
        "title": "Montaj Hattında Robotik Kol Pozisyonlama Sapması ve Duraksama",
        "description": "6 eksenli montaj robotu ön panel montajı sırasında ±2.5mm pozisyonlama sapması vererek güvenlik duruşuna (Safety Stop) geçti.",
        "methodology": "ishikawa",
        "category": "Otomasyon & Robotik",
        "industry": "Otomotiv",
        "root_cause": "3. eksen redüktör dişlisindeki aşınma ve resolver kablosunda oluşan elektromanyetik parazit (EMI).",
        "corrective_actions": "1. 3. eksen planet redüktörü değiştirildi.\n2. Resolver kablosu çift zırhlı kablo ile yenilendi.",
        "lessons_learned": "Robotik kol kablo demetleri 6 ayda bir termal kamera ve EMI ölçer ile denetlenecek.",
        "severity": 8, "occurrence": 3, "detection": 2,
        "task_title": "Robotik kol redüktör değişimi ve zırhlı kablo montajı",
        "task_status": "completed",
        "assignee": "Kadir Şen (Montaj Şefi)"
    },
    ...
    {
        "department": "Kalite",
        "title": "CMM Ölçüm Cihazı Z Ekseni Sapması ve Hatalı Muayene Raporları",
        "description": "Laboratuvardaki CMM ölçüm cihazında Z ekseninde 8 mikronluk sistematik ölçüm kayması tespit edildi.",
        "methodology": "5why",
        "category": "Laboratuvar & Ölçüm",
        "industry": "Havacılık & Savunma",
        "root_cause": "Laboratuvar iklimlendirme sistemindeki arıza nedeniyle ortam sıcaklığının 20°C standart yerine 26°C'ye yükselmesi.",
        "corrective_actions": "1. Laboratuvar hassas klima santrali yedekli hale getirildi.\n2. CMM lazer interferometre ile yeniden kalibre edildi.",
        "lessons_learned": "Laboratuvar sıcaklık sapmalarında CMM cihazını otomatik kilitleyen IoT sensör sistemi kuruldu.",
        "severity": 9, "occurrence": 3, "detection": 2,
        "task_title": "CMM lazer kalibrasyonu ve ortam iklimlendirme tamiri",
        "task_status": "completed",
        "assignee": "Ahmet Yılmaz (Kalite Uzmanı)"
    },
    {
        "department": "Kalite",
        "title": "Alüminyum Döküm Parçalarda Mikron Gözenek (Porozite) ve Basınç Kaçağı",
        "description": "Yüksek basınçlı alüminyum döküm vites kutusu gövdelerinde sızdırmazlık testinde %6.5 oranında kaçak tespit edildi.",
        "methodology": "8d",
        "category": "Döküm & Sızdırmazlık",
        "industry": "Otomotiv Döküm",
        "root_cause": "Döküm potasındaki azot gazı alma (degassing) süresinin yetersiz olması nedeniyle sıvı metal içinde hidrojen gazı kalması.",
        "corrective_actions": "1. Degassing süresi 8 dakikadan 14 dakikaya çıkarıldı.\n2. X-Ray porozite kontrol cihazı döküm çıkışına eklendi.",
        "lessons_learned": "Sıvı metal gaz miktarı her şarj öncesi porozite tayin cihazı ile ölçülmeden döküme izin verilmeyecek.",
        "severity": 9, "occurrence": 4, "detection": 3,
        "task_title": "Degassing süre optimizasyonu ve X-Ray tarama entegrasyonu",
        "task_status": "completed",
        "assignee": "Merve Şahin (Kalite Mühendisi)"
    },
    {
        "department": "Kalite",
        "title": "Otomotiv Koltuk Döşemesinde Dikiş Adımı Kayması ve Estetik Kusur",
        "description": "Deri koltuk kılıflarında dikiş adım aralığı 4mm standart yerine 6mm'ye çıkarak görsel kalite kontrol onayından geçemedi.",
        "methodology": "ishikawa",
        "category": "Tekstil & Döşeme",
        "industry": "Otomotiv İç Tasarım",
        "root_cause": "Otomatik dikiş makinesi alt besleme dişlisinin aşınması ve iplik tansiyon sensörünün kirlenmesi.",
        "corrective_actions": "1. Besleme dişlisi ve iplik tansiyon sensörü yenilendi.\n2. Kameralı dikiş adım kontrol sistemi devreye alındı.",
        "lessons_learned": "Dikiş makinelerinde her vardiya başında 50cm'lik test kumaşı dikişi zorunlu hale getirildi.",
        "severity": 6, "occurrence": 5, "detection": 2,
        "task_title": "Dikiş makinesi besleme dişlisi değişimi ve kamera entegrasyonu",
        "task_status": "completed",
